...
namespace WpfApplication4.ViewModel.Base
{
	public abstract class ViewModelBase : INotifyPropertyChanged
	{
		...
		{
			get { return GetValue<string>("InternalName"); }
			set { SetValue(value, "InternalName"); }
		}

		/// <summary>
		/// Called when the <see cref="DisplayName"/> property on this object has a new value.
		/// </summary>
		[PropertyChangedHandler("InternalName")]
		protected virtual void OnInternalNameChanged()
		{
			if (InternalNameSetsModified)
			{
				IsModified = true;
			}
		}
		...
		/// </summary>
		protected bool InternalNameSetsModified { get; set; }
